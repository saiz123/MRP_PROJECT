...
if menu == "🏠 Home":
    ...
    with col1:
        ...
        sns.scatterplot(x=dummy_data["Age"], y=dummy_data["Risk Score"], hue=dummy_data["Diabetes"], palette="coolwarm")
        plt.xlabel("Age")
    ...
    with col1:
        st.subheader("📊 Violin Plot: BMI vs Risk Score")
        fig, ax = plt.subplots(figsize=(6, 4))
        sns.violinplot(x=dummy_data["Diabetes"], y=dummy_data["BMI"], palette="coolwarm")
        plt.xlabel("Diabetes")
        plt.ylabel("BMI")
        st.pyplot(fig)

    with col2:
        st.subheader("📊 Box Plot: Heart Rate vs Risk Score")
        fig, ax = plt.subplots(figsize=(6, 4))
        sns.boxplot(x=dummy_data["Diabetes"], y=dummy_data["Heart Rate"], palette="coolwarm")
        plt.xlabel("Diabetes")
